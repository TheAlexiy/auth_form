                ...
                <div class="col-10 col-lg-5">
                    ...
                    <div class="form-group mt-3" style="max-width: 400px">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="radiobutton" required id="option1">
                            <label class="form-check-label" for="option1">
                                18-23
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="radiobutton" required id="option2">
                            <label class="form-check-label" for="option2">
                                24-27
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="radiobutton" required id="option3">
                    ...
                    <div class="input-group" style="width: 400px">
                        <label for="info" class="form-label font-weight-bold">Tell us about your experience with our
                            company
                    ...
                    <div class="row mt-3">
                        ...
                        <a class="btn btn-outline-primary ml-5 " href="">Reset form</a>
                    </div>
                </div>
            </div>
    </form>
